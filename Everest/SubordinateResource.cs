...
namespace Everest
{
    internal class SubordinateResource : RestClient, Response
    {
        ...
        public SubordinateResource(HttpResponseMessage httpResponseMessage, Uri url, HttpClientAdapterFactory adapterFactory, IEnumerable<PipelineOption> ambientPipelineOptions)
            : base(url, adapterFactory, ambientPipelineOptions)
        {
